...
public class TicTacToeApplication {
    ...
    public static void main(String[] args) {
        ...
        while(doYouWantToPlay) {
            ...
            System.out.println();
            System.out.println("Enter a single character that will represent you on"
                    + " the board");
            char playerToken = sc.next().charAt(0);
            System.out.println("Enter a single character that will represent your"
            ...
            System.out.println("Now we can start the game. To play, enter a number "
                    + "and your token shal be put in its place.\n The numbers go from"
                    + " 1 to 9, left to right. We shall see who will win this round.");
            ...
            System.out.println("Do you want to play again? Enter Y if you do."
                    + " Enter anything else if you tired of me.");
